...
export default function Register() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden flex items-center justify-center p-4 py-12 md:py-20">
            ...
            >
                ...
                <div className="text-center mb-9 flex flex-col items-center">
                    ...
                    <h1 className="mc-display text-[clamp(28px,5vw,34px)] mb-2" style={{ color: 'var(--mc-paper)' }}>
                        Create your account
                    </h1>
                    <p className="mc-body text-[14.5px]" style={{ color: 'var(--mc-muted)', maxWidth: 320 }}>
                ...
                {/* Form Card */}
                <div className="mc-card-form p-7 md:p-9 mb-6">
                                    ...
                                    <>
                                        <div className="flex flex-col">
                                            <label className="mc-label">
                                                Phone Number <span style={{ color: 'var(--mc-muted)', fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}> (optional)</span>
                                            </label>
                                        ...
                                        <div className="flex flex-col">
                                            <label className="mc-label">
                                                Location <span style={{ color: 'var(--mc-muted)', fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}> (optional)</span>
                                            </label>
                                    ...
                                    <>
                                        ...
                                        <div className="flex flex-col relative">
                                            ...
                                            <button
                                                ...
                                                className="absolute right-3.5 top-[34px] z-20 transition-colors"
                                                style={{ color: 'var(--mc-muted)' }}
                                            >
                    ...
                    {/* Buttons */}
                    <div className="flex gap-3 mt-8 pt-7" style={{ borderTop: '1px solid var(--mc-line)' }}>
                        {step > 0 && (
                            <motion.button
                ...
                <p className="text-center text-sm pb-6" style={{ color: 'var(--mc-muted)' }}>
                    Already have an account?{' '}
                    <Link
                        to="/login"
                        className="font-medium transition-colors"
                        style={{ color: 'var(--mc-coral)' }}
                    >
                        Sign in
                    </Link>
                </p>
